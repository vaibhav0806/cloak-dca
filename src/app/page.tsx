...
export default function Home() {
  ...
  // Show dashboard directly — beta gate disabled on devnet
    ...
    <footer className="border-t border-border bg-card/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-sm text-muted-foreground">
          <a href="https://x.com/cloakdefi" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors" aria-label="X (Twitter)">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 w-full relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-xs sm:text-sm text-muted-foreground/70">Devnet</span>
            </div>
