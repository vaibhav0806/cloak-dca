...
export async function POST(request: NextRequest) {
  try {
    ...
    // Only check input tokens (USDC/USDT) - these are what users deposit to privacy pool
    // Output tokens (SOL, cbBTC, ZEC) go directly to user's wallet after swaps, not privacy pool
